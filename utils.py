...
def validate(model, dataloader, args):
    ...
    with torch.no_grad():
        for tokened_data_dict in dataloader:
            ...
            loss, scores = get_batch_ret(model, args, **tokened_data_dict)
            labels_scores = tokened_data_dict['scores']
...
def test(model, dataloader, args):
    ...
    return batch_time, total_time, loss, scores
...
def get_batch_ret(model, args, **tokened_data_dict):
    ...
    loss, scores = model(**tokened_data_dict)
